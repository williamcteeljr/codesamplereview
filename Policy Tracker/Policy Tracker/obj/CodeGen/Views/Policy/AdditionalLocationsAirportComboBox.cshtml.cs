...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/Policy/AdditionalLocationsAirportComboBox.cshtml")]
    public partial class _Views_Policy_AdditionalLocationsAirportComboBox_cshtml : System.Web.Mvc.WebViewPage<PolicyTracker.DomainModel.Policy.Risk>
    {
        public _Views_Policy_AdditionalLocationsAirportComboBox_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 3 "..\..\Views\Policy\AdditionalLocationsAirportComboBox.cshtml"
Write(Html.DevExpress().ComboBoxFor(m => Model,
    settings =>
    {
        //var isEnabled = true;
